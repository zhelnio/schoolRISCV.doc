...
<!-- Итак, начнем с ADDI, и заполним таблицу только что найденными входными сигналами: opcode = 0010011, а funct3 = 000, при этом funct7 - не используется, и может иметь любое значение -->
