...
<!-- И финальные элементы тракта данных: мулитиплексоры на входе в АЛУ и порт записи регистрового файла. Реализуется с помощью уже знакомых вам тернарных операторов. -->
